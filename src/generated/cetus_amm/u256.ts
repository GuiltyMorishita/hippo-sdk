...
export function add_(a: U256, b: U256, $c: AptosDataCache): U256 {
...
export function and_(a: U256, b: U256, $c: AptosDataCache): U256 {
  let i, m, ret;
  ret = zero_($c);
  i = u64('0');
  while ($.copy(i).lt($.copy(WORDS))) {
...
export function as_u128_(a: U256, $c: AptosDataCache): U128 {
  let temp$1;
  ...
  return u128($.copy(a.v1))
    .shl(u8('64'))
    .add(u128($.copy(a.v0)));
}

export function as_u64_(a: U256, $c: AptosDataCache): U64 {
  let temp$1, temp$2;
...
export function bits_(a: U256, $c: AptosDataCache): U64 {
  let a1, a1__1, i;
  i = u64('1');
  while ($.copy(i).lt($.copy(WORDS))) {
    {
      ...
      if ($.copy(a1).gt(u64('0'))) {
        return u64('64')
          .mul($.copy(WORDS).sub($.copy(i)).add(u64('1')))
          .sub(u64(leading_zeros_u64_($.copy(a1), $c)));
      } else {
      }
      i = $.copy(i).add(u64('1'));
    }
...
export function compare_(a: U256, b: U256, $c: AptosDataCache): U8 {
  let a1, b1, i;
  i = $.copy(WORDS);
...
export function div_(a: U256, b: U256, $c: AptosDataCache): U256 {
...
export function du256_to_u256_(a: DU256, $c: AptosDataCache): [U256, boolean] {
...
export function from_bytes_(a: U8[], $c: AptosDataCache): U256 {
  let ret;
  ...
  put_(
    ret,
    u64('0'),
    u64($.copy(Stdlib.Vector.borrow_(a, u64('0'), $c, [AtomicTypeTag.U8])))
      .shl(u8('7'))
      .add(u64($.copy(Stdlib.Vector.borrow_(a, u64('1'), $c, [AtomicTypeTag.U8]))).shl(u8('6')))
      .add(u64($.copy(Stdlib.Vector.borrow_(a, u64('2'), $c, [AtomicTypeTag.U8]))).shl(u8('5')))
      .add(u64($.copy(Stdlib.Vector.borrow_(a, u64('3'), $c, [AtomicTypeTag.U8]))).shl(u8('4')))
      .add(u64($.copy(Stdlib.Vector.borrow_(a, u64('4'), $c, [AtomicTypeTag.U8]))).shl(u8('3')))
      .add(u64($.copy(Stdlib.Vector.borrow_(a, u64('5'), $c, [AtomicTypeTag.U8]))).shl(u8('2')))
      .add(u64($.copy(Stdlib.Vector.borrow_(a, u64('6'), $c, [AtomicTypeTag.U8]))).shl(u8('1')))
      .add(u64($.copy(Stdlib.Vector.borrow_(a, u64('7'), $c, [AtomicTypeTag.U8])))),
    $c
  );
  put_(
    ret,
    u64('1'),
    u64($.copy(Stdlib.Vector.borrow_(a, u64('8'), $c, [AtomicTypeTag.U8])))
      .shl(u8('7'))
      .add(u64($.copy(Stdlib.Vector.borrow_(a, u64('9'), $c, [AtomicTypeTag.U8]))).shl(u8('6')))
      .add(u64($.copy(Stdlib.Vector.borrow_(a, u64('10'), $c, [AtomicTypeTag.U8]))).shl(u8('5')))
      .add(u64($.copy(Stdlib.Vector.borrow_(a, u64('11'), $c, [AtomicTypeTag.U8]))).shl(u8('4')))
      .add(u64($.copy(Stdlib.Vector.borrow_(a, u64('12'), $c, [AtomicTypeTag.U8]))).shl(u8('3')))
      .add(u64($.copy(Stdlib.Vector.borrow_(a, u64('13'), $c, [AtomicTypeTag.U8]))).shl(u8('2')))
      .add(u64($.copy(Stdlib.Vector.borrow_(a, u64('14'), $c, [AtomicTypeTag.U8]))).shl(u8('1')))
      .add(u64($.copy(Stdlib.Vector.borrow_(a, u64('15'), $c, [AtomicTypeTag.U8])))),
    $c
  );
  put_(
    ret,
    u64('2'),
    u64($.copy(Stdlib.Vector.borrow_(a, u64('16'), $c, [AtomicTypeTag.U8])))
      .shl(u8('7'))
      .add(u64($.copy(Stdlib.Vector.borrow_(a, u64('17'), $c, [AtomicTypeTag.U8]))).shl(u8('6')))
      .add(u64($.copy(Stdlib.Vector.borrow_(a, u64('18'), $c, [AtomicTypeTag.U8]))).shl(u8('5')))
      .add(u64($.copy(Stdlib.Vector.borrow_(a, u64('19'), $c, [AtomicTypeTag.U8]))).shl(u8('4')))
      .add(u64($.copy(Stdlib.Vector.borrow_(a, u64('20'), $c, [AtomicTypeTag.U8]))).shl(u8('3')))
      .add(u64($.copy(Stdlib.Vector.borrow_(a, u64('21'), $c, [AtomicTypeTag.U8]))).shl(u8('2')))
      .add(u64($.copy(Stdlib.Vector.borrow_(a, u64('22'), $c, [AtomicTypeTag.U8]))).shl(u8('1')))
      .add(u64($.copy(Stdlib.Vector.borrow_(a, u64('23'), $c, [AtomicTypeTag.U8])))),
    $c
  );
  put_(
    ret,
    u64('3'),
    u64($.copy(Stdlib.Vector.borrow_(a, u64('24'), $c, [AtomicTypeTag.U8])))
      .shl(u8('7'))
      .add(u64($.copy(Stdlib.Vector.borrow_(a, u64('25'), $c, [AtomicTypeTag.U8]))).shl(u8('6')))
      .add(u64($.copy(Stdlib.Vector.borrow_(a, u64('26'), $c, [AtomicTypeTag.U8]))).shl(u8('5')))
      .add(u64($.copy(Stdlib.Vector.borrow_(a, u64('27'), $c, [AtomicTypeTag.U8]))).shl(u8('4')))
      .add(u64($.copy(Stdlib.Vector.borrow_(a, u64('28'), $c, [AtomicTypeTag.U8]))).shl(u8('3')))
      .add(u64($.copy(Stdlib.Vector.borrow_(a, u64('29'), $c, [AtomicTypeTag.U8]))).shl(u8('2')))
      .add(u64($.copy(Stdlib.Vector.borrow_(a, u64('30'), $c, [AtomicTypeTag.U8]))).shl(u8('1')))
      .add(u64($.copy(Stdlib.Vector.borrow_(a, u64('31'), $c, [AtomicTypeTag.U8])))),
    $c
  );
  return $.copy(ret);
}

export function from_u128_(val: U128, $c: AptosDataCache): U256 {
  let a1, a2;
  [a2, a1] = split_u128_($.copy(val), $c);
  return new U256({ v0: $.copy(a1), v1: $.copy(a2), v2: u64('0'), v3: u64('0') }, new SimpleStructTag(U256));
}

export function from_u64_(val: U64, $c: AptosDataCache): U256 {
  return from_u128_(u128($.copy(val)), $c);
}

export function get_(a: U256, i: U64, $c: AptosDataCache): U64 {
...
export function get_d_(a: DU256, i: U64, $c: AptosDataCache): U64 {
...
export function leading_zeros_u64_(a: U64, $c: AptosDataCache): U8 {
...
export function mul_(a: U256, b: U256, $c: AptosDataCache): U256 {
  let temp$1,
    temp$3,
    temp$7,
    a1,
    ...
    ret;
  ret = new DU256(
    { v0: u64('0'), v1: u64('0'), v2: u64('0'), v3: u64('0'), v4: u64('0'), v5: u64('0'), v6: u64('0'), v7: u64('0') },
    new SimpleStructTag(DU256)
  );
  i = u64('0');
  while ($.copy(i).lt($.copy(WORDS))) {
    {
...
export function or_(a: U256, b: U256, $c: AptosDataCache): U256 {
  let i, m, ret;
  ret = zero_($c);
  i = u64('0');
  while ($.copy(i).lt($.copy(WORDS))) {
...
export function overflowing_add_(a: U64, b: U64, $c: AptosDataCache): [U64, boolean] {
...
export function overflowing_sub_(a: U64, b: U64, $c: AptosDataCache): [U64, boolean] {
  let temp$1, temp$2, r;
  if ($.copy(a).lt($.copy(b))) {
    r = $.copy(b).sub($.copy(a));
...
export function put_(a: U256, i: U64, val: U64, $c: AptosDataCache): void {
  if ($.copy(i).eq(u64('0'))) {
    a.v0 = $.copy(val);
  } else {
    if ($.copy(i).eq(u64('1'))) {
...
export function put_d_(a: DU256, i: U64, val: U64, $c: AptosDataCache): void {
  if ($.copy(i).eq(u64('0'))) {
    a.v0 = $.copy(val);
  } else {
    if ($.copy(i).eq(u64('1'))) {
...
export function shl_(a: U256, shift: U8, $c: AptosDataCache): U256 {
  ...
  if ($.copy(bit_shift).gt(u64('0'))) {
    ...
    while ($.copy(j).lt($.copy(WORDS))) {
      {
        m__1 = get_(ret, $.copy(j), $c).add(
          get_(a, $.copy(j).sub(u64('1')).sub($.copy(word_shift)), $c).shr(u8('64').sub(u8($.copy(bit_shift))))
        );
...
export function shr_(a: U256, shift: U8, $c: AptosDataCache): U256 {
  let bit_shift, i, j, m, m__1, ret, word_shift;
  ret = zero_($c);
  word_shift = u64($.copy(shift)).div(u64('64'));
  bit_shift = u64($.copy(shift)).mod(u64('64'));
  ...
  if ($.copy(bit_shift).gt(u64('0'))) {
    ...
    while ($.copy(j).lt($.copy(WORDS))) {
      {
        m__1 = get_(ret, $.copy(j).sub($.copy(word_shift)).sub(u64('1')), $c).add(
          get_(a, $.copy(j), $c).shl(u8('64').sub(u8($.copy(bit_shift))))
        );
...
export function split_u128_(a: U128, $c: AptosDataCache): [U64, U64] {
  let a1, a2;
...
export function sub_(a: U256, b: U256, $c: AptosDataCache): U256 {
  let a1, b1, carry, i, is_overflow, is_overflow1, is_overflow2, res, res1, res2, ret;
  ret = zero_($c);
  carry = u64('0');
  i = u64('0');
...
export function to_bytes_(a: U256, $c: AptosDataCache): U8[] {
...
export function xor_(a: U256, b: U256, $c: AptosDataCache): U256 {
  let i, m, ret;
  ret = zero_($c);
  i = u64('0');
  while ($.copy(i).lt($.copy(WORDS))) {
...
export function zero_($c: AptosDataCache): U256 {
