...
export function add_(
  ...
  Stdlib.Table.add_(open_table.base_table, $.copy(key), value, $c, [
    $p[0],
    $p[1],
  ]);
...
export function borrow_(
  ...
  return Stdlib.Table.borrow_(open_table.base_table, $.copy(key), $c, [
    $p[0],
    $p[1],
  ]);
}
...
export function borrow_mut_(
  ...
  return Stdlib.Table.borrow_mut_(open_table.base_table, $.copy(key), $c, [
    $p[0],
    $p[1],
  ]);
}
...
export function contains_(
  ...
  return Stdlib.Table.contains_(open_table.base_table, $.copy(key), $c, [
    $p[0],
    $p[1],
  ]);
}
...
export function empty_(
  ...
  return new OpenTable(
    {
      base_table: Stdlib.Table.new___($c, [$p[0], $p[1]]),
      keys: Stdlib.Vector.empty_($c, [$p[0]]),
    },
