...
export class MarketInfo 
{
  ...
  { name: "trading_pair_info", typeTag: new StructTag(new HexString("0xc0deb00c9154b6b64db01eeb77d08255300315e1fa35b687d384a703f6034fbd"), "registry", "TradingPairInfo", []) }];
...
export class Registry 
{
  ...
  static fields: FieldDeclType[] = [
  { name: "hosts", typeTag: new StructTag(new HexString("0x1"), "table", "Table", [new StructTag(new HexString("0xc0deb00c9154b6b64db01eeb77d08255300315e1fa35b687d384a703f6034fbd"), "registry", "TradingPairInfo", []), AtomicTypeTag.Address]) },
  { name: "markets", typeTag: new VectorTag(new StructTag(new HexString("0xc0deb00c9154b6b64db01eeb77d08255300315e1fa35b687d384a703f6034fbd"), "registry", "MarketInfo", [])) },
...
export function get_verified_market_custodian_id_ (
  ...
  if (!$c.exists(new SimpleStructTag(Registry), new HexString("0xc0deb00c9154b6b64db01eeb77d08255300315e1fa35b687d384a703f6034fbd"))) {
    throw $.abortCode($.copy(E_NO_REGISTRY));
  }
  registry_ref = $c.borrow_global<Registry>(new SimpleStructTag(Registry), new HexString("0xc0deb00c9154b6b64db01eeb77d08255300315e1fa35b687d384a703f6034fbd"));
...
export function n_custodians_ (
  ...
  return $.copy($c.borrow_global<Registry>(new SimpleStructTag(Registry), new HexString("0xc0deb00c9154b6b64db01eeb77d08255300315e1fa35b687d384a703f6034fbd")).n_custodians);
}
...
export function n_markets_ (
  ...
  return Stdlib.Vector.length_($c.borrow_global<Registry>(new SimpleStructTag(Registry), new HexString("0xc0deb00c9154b6b64db01eeb77d08255300315e1fa35b687d384a703f6034fbd")).markets, $c, [new SimpleStructTag(MarketInfo)]);
}
...
export function register_custodian_capability_ (
  ...
  registry_ref_mut = $c.borrow_global_mut<Registry>(new SimpleStructTag(Registry), new HexString("0xc0deb00c9154b6b64db01eeb77d08255300315e1fa35b687d384a703f6034fbd"));
...
export function loadParsers(repo: AptosParserRepo) {
  repo.addParser("0xc0deb00c9154b6b64db01eeb77d08255300315e1fa35b687d384a703f6034fbd::registry::CustodianCapability", CustodianCapability.CustodianCapabilityParser);
  repo.addParser("0xc0deb00c9154b6b64db01eeb77d08255300315e1fa35b687d384a703f6034fbd::registry::GenericAsset", GenericAsset.GenericAssetParser);
  repo.addParser("0xc0deb00c9154b6b64db01eeb77d08255300315e1fa35b687d384a703f6034fbd::registry::MarketInfo", MarketInfo.MarketInfoParser);
  repo.addParser("0xc0deb00c9154b6b64db01eeb77d08255300315e1fa35b687d384a703f6034fbd::registry::Registry", Registry.RegistryParser);
  repo.addParser("0xc0deb00c9154b6b64db01eeb77d08255300315e1fa35b687d384a703f6034fbd::registry::TradingPairInfo", TradingPairInfo.TradingPairInfoParser);
}
export class App {
  constructor(
