...
export function loadParsers(repo: AptosParserRepo) {
  repo.addParser(
    '0xb1d4c0de8bc24468608637dfdbff975a0888f8935aa63338a44078eec5c7b6c7::market::EconiaCapabilityStore',
    EconiaCapabilityStore.EconiaCapabilityStoreParser
  );
  repo.addParser(
    '0xb1d4c0de8bc24468608637dfdbff975a0888f8935aa63338a44078eec5c7b6c7::market::Order',
    Order.OrderParser
  );
  repo.addParser(
    '0xb1d4c0de8bc24468608637dfdbff975a0888f8935aa63338a44078eec5c7b6c7::market::OrderBook',
    OrderBook.OrderBookParser
  );
  repo.addParser(
    '0xb1d4c0de8bc24468608637dfdbff975a0888f8935aa63338a44078eec5c7b6c7::market::PriceLevel',
    PriceLevel.PriceLevelParser
  );
  repo.addParser(
    '0xb1d4c0de8bc24468608637dfdbff975a0888f8935aa63338a44078eec5c7b6c7::market::SimpleOrder',
