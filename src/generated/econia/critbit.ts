...
export function borrow_closest_outer_node_ (
  ...
  if (is_outer_node_($.copy(tree.root), $c)) {
    return Std.Vector.borrow_(tree.outer_nodes, outer_node_vector_index_($.copy(tree.root), $c), $c, [new SimpleStructTag(OuterNode, [$p[0]])]);
  }
  else{
  }
  node = Std.Vector.borrow_(tree.inner_nodes, $.copy(tree.root), $c, [new SimpleStructTag(InnerNode)]);
  while (true) {
    ...
    if (is_outer_node_($.copy(child_index), $c)) {
      return Std.Vector.borrow_(tree.outer_nodes, outer_node_vector_index_($.copy(child_index), $c), $c, [new SimpleStructTag(OuterNode, [$p[0]])]);
    }
    else{
    }
    node = Std.Vector.borrow_(tree.inner_nodes, $.copy(child_index), $c, [new SimpleStructTag(InnerNode)]);
  }
}
...
export function borrow_closest_outer_node_mut_ (
  ...
  let temp$1, child_index, node;
  if (is_outer_node_($.copy(tree.root), $c)) {
    return Std.Vector.borrow_mut_(tree.outer_nodes, outer_node_vector_index_($.copy(tree.root), $c), $c, [new SimpleStructTag(OuterNode, [$p[0]])]);
  }
  else{
  }
  node = Std.Vector.borrow_(tree.inner_nodes, $.copy(tree.root), $c, [new SimpleStructTag(InnerNode)]);
  while (true) {
    ...
    child_index = temp$1;
    if (is_outer_node_($.copy(child_index), $c)) {
      return Std.Vector.borrow_mut_(tree.outer_nodes, outer_node_vector_index_($.copy(child_index), $c), $c, [new SimpleStructTag(OuterNode, [$p[0]])]);
    }
    else{
    }
    node = Std.Vector.borrow_(tree.inner_nodes, $.copy(child_index), $c, [new SimpleStructTag(InnerNode)]);
...
export function destroy_empty_ (
  ...
  Std.Vector.destroy_empty_(inner_nodes, $c, [new SimpleStructTag(InnerNode)]);
  Std.Vector.destroy_empty_(outer_nodes, $c, [new SimpleStructTag(OuterNode, [$p[0]])]);
  return;
}
...
export function empty_ (
  ...
  return new CritBitTree({ root: u64("0"), inner_nodes: Std.Vector.empty_($c, [new SimpleStructTag(InnerNode)]), outer_nodes: Std.Vector.empty_($c, [new SimpleStructTag(OuterNode, [$p[0]])]) }, new SimpleStructTag(CritBitTree, [$p[0]]));
}
...
export function insert_above_ (
  ...
  let node, node_index;
  node_index = $.copy(Std.Vector.borrow_(tree.inner_nodes, $.copy(search_parent_index), $c, [new SimpleStructTag(InnerNode)]).parent_index);
  while (true) {
    if (($.copy(node_index)).eq(($.copy(ROOT)))) {
      ...
      node = Std.Vector.borrow_mut_(tree.inner_nodes, $.copy(node_index), $c, [new SimpleStructTag(InnerNode)]);
...
export function insert_above_root_ (
  ...
  Std.Vector.borrow_mut_(tree.inner_nodes, $.copy(old_root_index), $c, [new SimpleStructTag(InnerNode)]).parent_index = $.copy(n_inner_nodes);
...
export function insert_below_ (
  ...
  let search_parent;
  search_parent = Std.Vector.borrow_mut_(tree.inner_nodes, $.copy(search_parent_index), $c, [new SimpleStructTag(InnerNode)]);
  ...
  Std.Vector.borrow_mut_(tree.outer_nodes, outer_node_vector_index_($.copy(search_index), $c), $c, [new SimpleStructTag(OuterNode, [$p[0]])]).parent_index = $.copy(n_inner_nodes);
...
export function insert_below_walk_ (
  ...
  review_node = Std.Vector.borrow_mut_(tree.inner_nodes, $.copy(review_node_index), $c, [new SimpleStructTag(InnerNode)]);
  ...
  Std.Vector.borrow_mut_(tree.inner_nodes, $.copy(walked_child_index), $c, [new SimpleStructTag(InnerNode)]).parent_index = $.copy(n_inner_nodes);
...
export function insert_empty_ (
  ...
  Std.Vector.push_back_(tree.outer_nodes, new OuterNode({ key: $.copy(key), value: value, parent_index: $.copy(ROOT) }, new SimpleStructTag(OuterNode, [$p[0]])), $c, [new SimpleStructTag(OuterNode, [$p[0]])]);
...
export function insert_general_ (
  ...
  n_inner_nodes = Std.Vector.length_(tree.inner_nodes, $c, [new SimpleStructTag(InnerNode)]);
...
export function insert_singleton_ (
  ...
  outer_node = Std.Vector.borrow_(tree.outer_nodes, u64("0"), $c, [new SimpleStructTag(OuterNode, [$p[0]])]);
  ...
  tree.root = u64("0");
  Std.Vector.borrow_mut_(tree.outer_nodes, u64("0"), $c, [new SimpleStructTag(OuterNode, [$p[0]])]).parent_index = u64("0");
  return;
}
...
export function is_empty_ (
  ...
  return Std.Vector.is_empty_(tree.outer_nodes, $c, [new SimpleStructTag(OuterNode, [$p[0]])]);
}
...
export function length_ (
  ...
  return Std.Vector.length_(tree.outer_nodes, $c, [new SimpleStructTag(OuterNode, [$p[0]])]);
}
...
export function max_key_ (
  ...
  return $.copy(Std.Vector.borrow_(tree.outer_nodes, outer_node_vector_index_(max_node_child_index_(tree, $c, [$p[0]]), $c), $c, [new SimpleStructTag(OuterNode, [$p[0]])]).key);
}
...
export function max_node_child_index_ (
  ...
  while (true) {
    ...
    child_field_index = $.copy(Std.Vector.borrow_(tree.inner_nodes, $.copy(child_field_index), $c, [new SimpleStructTag(InnerNode)]).right_child_index);
  }
}
...
export function min_key_ (
  ...
  return $.copy(Std.Vector.borrow_(tree.outer_nodes, outer_node_vector_index_(min_node_child_index_(tree, $c, [$p[0]]), $c), $c, [new SimpleStructTag(OuterNode, [$p[0]])]).key);
}
...
export function min_node_child_index_ (
  ...
  while (true) {
    ...
    child_field_index = $.copy(Std.Vector.borrow_(tree.inner_nodes, $.copy(child_field_index), $c, [new SimpleStructTag(InnerNode)]).left_child_index);
  }
}
...
export function pop_destroy_nodes_ (
  ...
  let n_inner_nodes;
  n_inner_nodes = Std.Vector.length_(tree.inner_nodes, $c, [new SimpleStructTag(InnerNode)]);
  Std.Vector.swap_remove_(tree.inner_nodes, $.copy(inner_index), $c, [new SimpleStructTag(InnerNode)]);
  if (($.copy(inner_index)).lt(($.copy(n_inner_nodes)).sub(u64("1")))) {
    stitch_swap_remove_(tree, $.copy(inner_index), $.copy(n_inner_nodes), $c, [$p[0]]);
  }
  else{
  }
  let { value: value } = Std.Vector.swap_remove_(tree.outer_nodes, outer_node_vector_index_($.copy(outer_index), $c), $c, [new SimpleStructTag(OuterNode, [$p[0]])]);
...
export function pop_singleton_ (
  ...
  if (!($.copy(Std.Vector.borrow_(tree.outer_nodes, u64("0"), $c, [new SimpleStructTag(OuterNode, [$p[0]])]).key)).eq(($.copy(key)))) {
    throw $.abortCode($.copy(E_NOT_HAS_KEY));
  }
  tree.root = u64("0");
  let { value: value } = Std.Vector.pop_back_(tree.outer_nodes, $c, [new SimpleStructTag(OuterNode, [$p[0]])]);
  return value;
}
...
export function pop_update_relationships_ (
  ...
  parent = Std.Vector.borrow_(tree.inner_nodes, $.copy(parent_index), $c, [new SimpleStructTag(InnerNode)]);
  ...
  if (is_outer_node_($.copy(sibling_index), $c)) {
    Std.Vector.borrow_mut_(tree.outer_nodes, outer_node_vector_index_($.copy(sibling_index), $c), $c, [new SimpleStructTag(OuterNode, [$p[0]])]).parent_index = $.copy(grandparent_index);
  }
  else{
    Std.Vector.borrow_mut_(tree.inner_nodes, $.copy(sibling_index), $c, [new SimpleStructTag(InnerNode)]).parent_index = $.copy(grandparent_index);
  }
  if (($.copy(grandparent_index)).eq(($.copy(ROOT)))) {
    tree.root = $.copy(sibling_index);
  }
  else{
    grandparent = Std.Vector.borrow_mut_(tree.inner_nodes, $.copy(grandparent_index), $c, [new SimpleStructTag(InnerNode)]);
...
export function push_back_insert_nodes_ (
  ...
  Std.Vector.push_back_(tree.outer_nodes, new OuterNode({ key: $.copy(key), value: value, parent_index: $.copy(inner_index) }, new SimpleStructTag(OuterNode, [$p[0]])), $c, [new SimpleStructTag(OuterNode, [$p[0]])]);
  Std.Vector.push_back_(tree.inner_nodes, new InnerNode({ critical_bit: $.copy(critical_bit), parent_index: $.copy(parent_index), left_child_index: $.copy(left_child_index), right_child_index: $.copy(right_child_index) }, new SimpleStructTag(InnerNode)), $c, [new SimpleStructTag(InnerNode)]);
  return;
}
...
export function search_outer_ (
  ...
  parent = Std.Vector.borrow_(tree.inner_nodes, $.copy(tree.root), $c, [new SimpleStructTag(InnerNode)]);
  while (true) {
    ...
    if (is_outer_node_($.copy(index), $c)) {
      node = Std.Vector.borrow_(tree.outer_nodes, outer_node_vector_index_($.copy(index), $c), $c, [new SimpleStructTag(OuterNode, [$p[0]])]);
      return [$.copy(index), side, $.copy(node.key), $.copy(node.parent_index), $.copy(parent.critical_bit)];
    }
    else{
    }
    parent = Std.Vector.borrow_(tree.inner_nodes, $.copy(index), $c, [new SimpleStructTag(InnerNode)]);
  }
}
...
export function singleton_ (
  ...
  let tree;
  tree = new CritBitTree({ root: u64("0"), inner_nodes: Std.Vector.empty_($c, [new SimpleStructTag(InnerNode)]), outer_nodes: Std.Vector.empty_($c, [new SimpleStructTag(OuterNode, [$p[0]])]) }, new SimpleStructTag(CritBitTree, [$p[0]]));
  insert_empty_(tree, $.copy(key), value, $c, [$p[0]]);
  return tree;
}
...
export function stitch_child_of_parent_ (
  ...
  let parent;
  parent = Std.Vector.borrow_mut_(tree.inner_nodes, $.copy(parent_index), $c, [new SimpleStructTag(InnerNode)]);
...
export function stitch_parent_of_child_ (
  ...
  if (is_outer_node_($.copy(child_index), $c)) {
    Std.Vector.borrow_mut_(tree.outer_nodes, outer_node_vector_index_($.copy(child_index), $c), $c, [new SimpleStructTag(OuterNode, [$p[0]])]).parent_index = $.copy(new_index);
  }
  else{
    Std.Vector.borrow_mut_(tree.inner_nodes, $.copy(child_index), $c, [new SimpleStructTag(InnerNode)]).parent_index = $.copy(new_index);
  }
  return;
}
...
export function stitch_swap_remove_ (
  ...
  if (is_outer_node_($.copy(node_index), $c)) {
    parent_index = $.copy(Std.Vector.borrow_(tree.outer_nodes, outer_node_vector_index_($.copy(node_index), $c), $c, [new SimpleStructTag(OuterNode, [$p[0]])]).parent_index);
    ...
    node = Std.Vector.borrow_(tree.inner_nodes, $.copy(node_index), $c, [new SimpleStructTag(InnerNode)]);
...
export function traverse_end_pop_ (
  ...
  if (($.copy(n_outer_nodes)).eq((u64("1")))) {
    ...
    node_child_side = ($.copy(Std.Vector.borrow_(tree.inner_nodes, $.copy(parent_index), $c, [new SimpleStructTag(InnerNode)]).left_child_index)).eq(($.copy(child_index)));
...
export function traverse_init_mut_ (
  ...
  node = Std.Vector.borrow_mut_(tree.outer_nodes, outer_node_vector_index_($.copy(child_field_index), $c), $c, [new SimpleStructTag(OuterNode, [$p[0]])]);
...
export function traverse_mut_ (
  ...
  node = Std.Vector.borrow_mut_(tree.outer_nodes, outer_node_vector_index_($.copy(target_child_index), $c), $c, [new SimpleStructTag(OuterNode, [$p[0]])]);
...
export function traverse_pop_mut_ (
  ...
  start_child_side = ($.copy(Std.Vector.borrow_(tree.inner_nodes, $.copy(parent_index), $c, [new SimpleStructTag(InnerNode)]).left_child_index)).eq(($.copy(child_index)));
  [temp$1, temp$2, temp$3, temp$4] = [tree, $.copy(key), $.copy(parent_index), direction];
  target_child_index = traverse_target_child_index_(temp$1, temp$2, temp$3, temp$4, $c, [$p[0]]);
  ...
  target_node = Std.Vector.borrow_mut_(tree.outer_nodes, outer_node_vector_index_($.copy(target_child_index), $c), $c, [new SimpleStructTag(OuterNode, [$p[0]])]);
...
export function traverse_target_child_index_ (
  ...
  while ((direction != is_set_($.copy(key), $.copy(parent.critical_bit), $c))) {
    {
      parent = Std.Vector.borrow_(tree.inner_nodes, $.copy(parent.parent_index), $c, [new SimpleStructTag(InnerNode)]);
    }
  ...
  while (!is_outer_node_($.copy(child_index), $c)) {
    {
      if ((direction == $.copy(LEFT))) {
        temp$2 = $.copy(Std.Vector.borrow_(tree.inner_nodes, $.copy(child_index), $c, [new SimpleStructTag(InnerNode)]).right_child_index);
      }
      else{
        temp$2 = $.copy(Std.Vector.borrow_(tree.inner_nodes, $.copy(child_index), $c, [new SimpleStructTag(InnerNode)]).left_child_index);
      }
      child_index = temp$2;
    }
