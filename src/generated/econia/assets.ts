...
export function burn_(coins: Stdlib.Coin.Coin, $c: AptosDataCache, $p: TypeTag[] /* <CoinType>*/): void {
  let burn_capability;
...
export function init_coin_types_(account: HexString, $c: AptosDataCache): void {
  init_coin_type_(account, $.copy(BASE_COIN_NAME), $.copy(BASE_COIN_SYMBOL), $.copy(BASE_COIN_DECIMALS), $c, [
    new SimpleStructTag(BC)
  ]);
  init_coin_type_(account, $.copy(QUOTE_COIN_NAME), $.copy(QUOTE_COIN_SYMBOL), $.copy(QUOTE_COIN_DECIMALS), $c, [
...
export function loadParsers(repo: AptosParserRepo) {
  repo.addParser('0xe56148c106146758a4172a7189cd8487f84997de6f6c2b3396106a8f82cb0c33::assets::BC', BC.BCParser);
  repo.addParser(
    '0xe56148c106146758a4172a7189cd8487f84997de6f6c2b3396106a8f82cb0c33::assets::CoinCapabilities',
    CoinCapabilities.CoinCapabilitiesParser
  );
  repo.addParser('0xe56148c106146758a4172a7189cd8487f84997de6f6c2b3396106a8f82cb0c33::assets::QC', QC.QCParser);
}
export class App {
