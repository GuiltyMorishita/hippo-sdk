...
export function add_approver_to_registry_(admin: HexString, approver: HexString, $c: AptosDataCache): void {
  ...
  if (
    !(
      ...
      new HexString('0xb5d6dbc225e8c42cec66664ebbccaef2098107f699510613a0b90214f659bb46').hex()
    )
  ) {
...
export function loadParsers(repo: AptosParserRepo) {
  repo.addParser(
    '0xb5d6dbc225e8c42cec66664ebbccaef2098107f699510613a0b90214f659bb46::coin_list::CoinInfo',
    CoinInfo.CoinInfoParser
  );
  repo.addParser(
    '0xb5d6dbc225e8c42cec66664ebbccaef2098107f699510613a0b90214f659bb46::coin_list::CoinList',
    CoinList.CoinListParser
  );
  repo.addParser(
    '0xb5d6dbc225e8c42cec66664ebbccaef2098107f699510613a0b90214f659bb46::coin_list::CoinRegistry',
    CoinRegistry.CoinRegistryParser
  );
  repo.addParser(
    '0xb5d6dbc225e8c42cec66664ebbccaef2098107f699510613a0b90214f659bb46::coin_list::FullList',
    FullList.FullListParser
  );
  repo.addParser(
    '0xb5d6dbc225e8c42cec66664ebbccaef2098107f699510613a0b90214f659bb46::coin_list::Nothing',
