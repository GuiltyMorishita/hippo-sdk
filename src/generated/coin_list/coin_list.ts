...
export class CoinList {
  ...
  static fields: FieldDeclType[] = [
    {
      name: 'coin_types',
      typeTag: new StructTag(new HexString('0x1'), 'iterable_table', 'IterableTable', [
...
export function add_extension_(
  ...
  coin_info = Stdlib.Iterable_table.borrow_mut_(registry.type_to_coin_info, $.copy(type_info), $c, [
    new StructTag(new HexString('0x1'), 'type_info', 'TypeInfo', []),
...
export function add_to_list_(list_owner: HexString, $c: AptosDataCache, $p: TypeTag[] /* <CoinType>*/): void {
  ...
  Stdlib.Iterable_table.add_(list.coin_types, $.copy(coin_type), new Nothing({}, new SimpleStructTag(Nothing)), $c, [
    new StructTag(new HexString('0x1'), 'type_info', 'TypeInfo', []),
...
export function add_to_registry_(
  ...
  if (!is_update) {
    if (
      !!Stdlib.Iterable_table.contains_(registry.type_to_coin_info, $.copy(type_info), $c, [
        new StructTag(new HexString('0x1'), 'type_info', 'TypeInfo', []),
        new SimpleStructTag(CoinInfo)
      ])
    ) {
    ...
    Stdlib.Iterable_table.remove_(registry.type_to_coin_info, $.copy(type_info), $c, [
      new StructTag(new HexString('0x1'), 'type_info', 'TypeInfo', []),
      new SimpleStructTag(CoinInfo)
    ]);
  }
  Stdlib.Iterable_table.add_(registry.type_to_coin_info, $.copy(type_info), $.copy(coin_info), $c, [
    new StructTag(new HexString('0x1'), 'type_info', 'TypeInfo', []),
    new SimpleStructTag(CoinInfo)
  ]);
  return;
...
export function create_list_(list_owner: HexString, $c: AptosDataCache): void {
  return $c.move_to(
    ...
    new CoinList(
      {
        coin_types: Stdlib.Iterable_table.new___($c, [
          new StructTag(new HexString('0x1'), 'type_info', 'TypeInfo', []),
          new SimpleStructTag(Nothing)
        ])
      },
...
export function get_all_registered_coin_info_($c: AptosDataCache): FullList {
  ...
  tail = Stdlib.Iterable_table.tail_key_(registry.type_to_coin_info, $c, [
    new StructTag(new HexString('0x1'), 'type_info', 'TypeInfo', []),
    new SimpleStructTag(CoinInfo)
  ]);
  ...
  while (Stdlib.Option.is_some_(tail, $c, [new StructTag(new HexString('0x1'), 'type_info', 'TypeInfo', [])])) {
    {
      ...
      coin_info = Stdlib.Iterable_table.borrow_(registry.type_to_coin_info, $.copy(tail_key), $c, [
        new StructTag(new HexString('0x1'), 'type_info', 'TypeInfo', []),
        new SimpleStructTag(CoinInfo)
      ]);
      Stdlib.Vector.push_back_(fulllist.coin_info_list, $.copy(coin_info), $c, [new SimpleStructTag(CoinInfo)]);
      [, prev] = Stdlib.Iterable_table.borrow_iter_(registry.type_to_coin_info, $.copy(tail_key), $c, [
        new StructTag(new HexString('0x1'), 'type_info', 'TypeInfo', []),
        new SimpleStructTag(CoinInfo)
      ]);
      tail = $.copy(prev);
...
export function get_coin_info_($c: AptosDataCache, $p: TypeTag[] /* <CoinType>*/): CoinInfo {
  ...
  type_info = Stdlib.Type_info.type_of_($c, [$p[0]]);
  return $.copy(
    Stdlib.Iterable_table.borrow_(registry.type_to_coin_info, $.copy(type_info), $c, [
      new StructTag(new HexString('0x1'), 'type_info', 'TypeInfo', []),
      new SimpleStructTag(CoinInfo)
    ])
  );
...
export function get_full_list_(list_owner_addr: HexString, $c: AptosDataCache): FullList {
  ...
  tail = Stdlib.Iterable_table.tail_key_(list.coin_types, $c, [
    new StructTag(new HexString('0x1'), 'type_info', 'TypeInfo', []),
    new SimpleStructTag(Nothing)
  ]);
  fulllist = new FullList(
  ...
  while (Stdlib.Option.is_some_(tail, $c, [new StructTag(new HexString('0x1'), 'type_info', 'TypeInfo', [])])) {
    {
      ...
      Stdlib.Vector.push_back_(fulllist.coin_info_list, $.copy(coin_info), $c, [new SimpleStructTag(CoinInfo)]);
      [, prev] = Stdlib.Iterable_table.borrow_iter_(list.coin_types, $.copy(tail_key), $c, [
        new StructTag(new HexString('0x1'), 'type_info', 'TypeInfo', []),
        new SimpleStructTag(Nothing)
      ]);
      tail = $.copy(prev);
...
export function initialize_(admin: HexString, $c: AptosDataCache): void {
  ...
  return $c.move_to(
    ...
    new CoinRegistry(
      {
        type_to_coin_info: Stdlib.Iterable_table.new___($c, [
          new StructTag(new HexString('0x1'), 'type_info', 'TypeInfo', []),
          new SimpleStructTag(CoinInfo)
        ])
      },
...
export function is_coin_in_list_(
  ...
  list = $c.borrow_global<CoinList>(new SimpleStructTag(CoinList), $.copy(list_owner_addr));
  coin_type = Stdlib.Type_info.type_of_($c, [$p[0]]);
  return Stdlib.Iterable_table.contains_(list.coin_types, $.copy(coin_type), $c, [
    new StructTag(new HexString('0x1'), 'type_info', 'TypeInfo', []),
    new SimpleStructTag(Nothing)
  ]);
}
...
export function is_coin_registered_($c: AptosDataCache, $p: TypeTag[] /* <CoinType>*/): boolean {
  ...
  type_info = Stdlib.Type_info.type_of_($c, [$p[0]]);
  return Stdlib.Iterable_table.contains_(registry.type_to_coin_info, $.copy(type_info), $c, [
    new StructTag(new HexString('0x1'), 'type_info', 'TypeInfo', []),
    new SimpleStructTag(CoinInfo)
  ]);
}
...
export function remove_from_list_(list_owner: HexString, $c: AptosDataCache, $p: TypeTag[] /* <CoinType>*/): void {
  ...
  coin_type = Stdlib.Type_info.type_of_($c, [$p[0]]);
  Stdlib.Iterable_table.remove_(list.coin_types, $.copy(coin_type), $c, [
    new StructTag(new HexString('0x1'), 'type_info', 'TypeInfo', []),
    new SimpleStructTag(Nothing)
  ]);
  return;
...
export class App {
  ...
  async add_to_list(_account: AptosAccount, $p: TypeTag[] /* <CoinType>*/, _maxGas = 1000, _isJSON = false) {
  ...
  payload_add_to_registry_by_admin(
    ...
    return buildPayload_add_to_registry_by_admin(
      name,
      symbol,
      coingecko_id,
      logo_url,
  ...
  async add_to_registry_by_admin(
    ...
    const payload = buildPayload_add_to_registry_by_admin(
      name,
      symbol,
      coingecko_id,
      logo_url,
