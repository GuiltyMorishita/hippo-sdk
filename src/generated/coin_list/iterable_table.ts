...
export function add_(table: IterableTable, key: any, val: any, $c: AptosDataCache, $p: TypeTag[] /* <K, V>*/): void {
  let k, wrapped_value;
  wrapped_value = new IterableValue(
    { val: val, prev: $.copy(table.tail), next: Stdlib.Option.none_($c, [$p[0]]) },
...
export function append_(v1: IterableTable, v2: IterableTable, $c: AptosDataCache, $p: TypeTag[] /* <K, V>*/): void {
  let key, next, val;
...
export function borrow_(table: IterableTable, key: any, $c: AptosDataCache, $p: TypeTag[] /* <K, V>*/): any {
...
export function borrow_mut_(table: IterableTable, key: any, $c: AptosDataCache, $p: TypeTag[] /* <K, V>*/): any {
...
export function contains_(table: IterableTable, key: any, $c: AptosDataCache, $p: TypeTag[] /* <K, V>*/): boolean {
...
export function destroy_empty_(table: IterableTable, $c: AptosDataCache, $p: TypeTag[] /* <K, V>*/): void {
...
export function empty_(table: IterableTable, $c: AptosDataCache, $p: TypeTag[] /* <K, V>*/): boolean {
  return Stdlib.Table_with_length.empty_(table.inner, $c, [$p[0], new SimpleStructTag(IterableValue, [$p[0], $p[1]])]);
}

export function head_key_(table: IterableTable, $c: AptosDataCache, $p: TypeTag[] /* <K, V>*/): Stdlib.Option.Option {
  return $.copy(table.head);
}

export function length_(table: IterableTable, $c: AptosDataCache, $p: TypeTag[] /* <K, V>*/): U64 {
  return Stdlib.Table_with_length.length_(table.inner, $c, [$p[0], new SimpleStructTag(IterableValue, [$p[0], $p[1]])]);
}

export function new___($c: AptosDataCache, $p: TypeTag[] /* <K, V>*/): IterableTable {
  return new IterableTable(
    {
      inner: Stdlib.Table_with_length.new___($c, [$p[0], new SimpleStructTag(IterableValue, [$p[0], $p[1]])]),
...
export function remove_(table: IterableTable, key: any, $c: AptosDataCache, $p: TypeTag[] /* <K, V>*/): any {
  let val;
...
export function tail_key_(table: IterableTable, $c: AptosDataCache, $p: TypeTag[] /* <K, V>*/): Stdlib.Option.Option {
  return $.copy(table.tail);
}

export function loadParsers(repo: AptosParserRepo) {
  repo.addParser(
    '0xb5d6dbc225e8c42cec66664ebbccaef2098107f699510613a0b90214f659bb46::iterable_table::IterableTable',
    IterableTable.IterableTableParser
  );
  repo.addParser(
    '0xb5d6dbc225e8c42cec66664ebbccaef2098107f699510613a0b90214f659bb46::iterable_table::IterableValue',
