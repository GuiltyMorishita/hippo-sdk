...
export function mock_deploy_basiq_(admin: HexString, $c: AptosDataCache): void {
  ...
  Coin_list.Devnet_coins.mint_to_wallet_(admin, $.copy(STABLE_COIN_AMOUNT), $c, [
    new StructTag(
      new HexString('0x498d8926f16eb9ca90cab1b3a26aa6f97a080b3fcbe6e83ae150b7243a00fb68'),
      'devnet_coins',
      'DevnetUSDC',
  ...
  Basiq.Dex.admin_create_pool_(
    admin,
    $.copy(STABLE_COIN_AMOUNT).div($.copy(BTC_AMOUNT)).mul(u64('1000000')),
  ...
  Basiq.Dex.add_liquidity_entry_(admin, $.copy(BTC_AMOUNT), $.copy(STABLE_COIN_AMOUNT), $c, [
    new StructTag(
      new HexString('0x498d8926f16eb9ca90cab1b3a26aa6f97a080b3fcbe6e83ae150b7243a00fb68'),
      'devnet_coins',
      'DevnetBTC',
...
export function mock_deploy_econia_(admin: HexString, market_id: U64, $c: AptosDataCache): void {
  ...
  Econia.User.deposit_from_coinstore_(admin, $.copy(market_id), u64('0'), $.copy(STABLE_COIN_AMOUNT), $c, [
    new StructTag(
      new HexString('0x498d8926f16eb9ca90cab1b3a26aa6f97a080b3fcbe6e83ae150b7243a00fb68'),
      'devnet_coins',
      'DevnetUSDC',
