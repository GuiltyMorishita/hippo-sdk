...
export class Volume 
{
  ...
  { name: "total_volume_history_24h", typeTag: new VectorTag(new StructTag(new HexString("0xdad1c1d54fcff3bf0d83b4b0067d7cf0ebdca3ff17556f77115ada2db1ff23fe"), "volume", "TotalVolume", [])) },
  { name: "total_volume_history_7d", typeTag: new VectorTag(new StructTag(new HexString("0xdad1c1d54fcff3bf0d83b4b0067d7cf0ebdca3ff17556f77115ada2db1ff23fe"), "volume", "TotalVolume", [])) },
  { name: "top_trading_pairs_24h", typeTag: new VectorTag(new StructTag(new HexString("0xdad1c1d54fcff3bf0d83b4b0067d7cf0ebdca3ff17556f77115ada2db1ff23fe"), "volume", "TradingPair", [])) },
  { name: "top_trading_pairs_7d", typeTag: new VectorTag(new StructTag(new HexString("0xdad1c1d54fcff3bf0d83b4b0067d7cf0ebdca3ff17556f77115ada2db1ff23fe"), "volume", "TradingPair", [])) },
  { name: "top_pool_provider_24h", typeTag: new VectorTag(new StructTag(new HexString("0xdad1c1d54fcff3bf0d83b4b0067d7cf0ebdca3ff17556f77115ada2db1ff23fe"), "volume", "PoolProvider", [])) },
  { name: "top_pool_provider_7d", typeTag: new VectorTag(new StructTag(new HexString("0xdad1c1d54fcff3bf0d83b4b0067d7cf0ebdca3ff17556f77115ada2db1ff23fe"), "volume", "PoolProvider", [])) }];
...
export function add_volume_ (
  ...
  if (($.copy(array_length)).eq((u64("0")))) {
    Stdlib.Vector.push_back_(total_volume_array, new TotalVolume({ start_time: $.copy(round_start_time), end_time: $.copy(data_end_time), amount: $.copy(amount) }, new SimpleStructTag(TotalVolume)), $c, [new SimpleStructTag(TotalVolume)]);
    return;
  }
  else{
  }
...
export function clean_ (
  ...
  let volume;
  volume = $c.borrow_global_mut<Volume>(new SimpleStructTag(Volume), new HexString("0xdad1c1d54fcff3bf0d83b4b0067d7cf0ebdca3ff17556f77115ada2db1ff23fe"));
...
export function get_volume_ (
  ...
  return $.copy($c.borrow_global<Volume>(new SimpleStructTag(Volume), new HexString("0xdad1c1d54fcff3bf0d83b4b0067d7cf0ebdca3ff17556f77115ada2db1ff23fe")));
}
...
export function initialize_ (
  ...
  if (!(($.copy(admin_addr)).hex() === (new HexString("0xdad1c1d54fcff3bf0d83b4b0067d7cf0ebdca3ff17556f77115ada2db1ff23fe")).hex())) {
    throw $.abortCode($.copy(E_NOT_ADMIN));
  }
  return $c.move_to(new SimpleStructTag(Volume), admin, new Volume({ poster: $.copy(poster), total_volume: u128("0"), data_end_sequence_number: u64("0"), data_end_time: u64("0"), volume_decimals: u64("4"), total_volume_history_24h: Stdlib.Vector.empty_($c, [new SimpleStructTag(TotalVolume)]), total_volume_history_7d: Stdlib.Vector.empty_($c, [new SimpleStructTag(TotalVolume)]), top_trading_pairs_24h: Stdlib.Vector.empty_($c, [new SimpleStructTag(TradingPair)]), top_trading_pairs_7d: Stdlib.Vector.empty_($c, [new SimpleStructTag(TradingPair)]), top_pool_provider_24h: Stdlib.Vector.empty_($c, [new SimpleStructTag(PoolProvider)]), top_pool_provider_7d: Stdlib.Vector.empty_($c, [new SimpleStructTag(PoolProvider)]) }, new SimpleStructTag(Volume)));
}
...
export function post_ (
  ...
  if (!($.copy(new_data_end_seauence_number)).neq($.copy(volume.data_end_sequence_number))) {
    throw $.abortCode($.copy(E_REPEAT_POST));
  }
  ...
  add_volume_(volume.total_volume_history_24h, $.copy(round_start_time_24h), $.copy(new_data_end_time), $.copy(amount), $c);
  add_volume_(volume.total_volume_history_7d, $.copy(round_start_time_7d), $.copy(new_data_end_time), $.copy(amount), $c);
...
export function loadParsers(repo: AptosParserRepo) {
  repo.addParser("0xdad1c1d54fcff3bf0d83b4b0067d7cf0ebdca3ff17556f77115ada2db1ff23fe::volume::PoolProvider", PoolProvider.PoolProviderParser);
  repo.addParser("0xdad1c1d54fcff3bf0d83b4b0067d7cf0ebdca3ff17556f77115ada2db1ff23fe::volume::TotalVolume", TotalVolume.TotalVolumeParser);
  repo.addParser("0xdad1c1d54fcff3bf0d83b4b0067d7cf0ebdca3ff17556f77115ada2db1ff23fe::volume::TradingPair", TradingPair.TradingPairParser);
  repo.addParser("0xdad1c1d54fcff3bf0d83b4b0067d7cf0ebdca3ff17556f77115ada2db1ff23fe::volume::Volume", Volume.VolumeParser);
}
export class App {
  constructor(
  ...
  get query_fetch_volume() { return make_query_fetch_volume(this); }
  payload_get_volume(
    isJSON = false,
  ): TxnBuilderTypes.TransactionPayloadEntryFunction
        | Types.TransactionPayload_EntryFunctionPayload {
  ...
  payload_post(
    ...
    isJSON = false,
        ...
        | Types.TransactionPayload_EntryFunctionPayload {
    return buildPayload_post(amount, round_start_time_24h, round_start_time_7d, new_data_end_time, new_data_end_seauence_number, trading_pairs_24h_coin_x, trading_pairs_24h_coin_y, trading_pairs_24h_amount, trading_pairs_7d_coin_x, trading_pairs_7d_coin_y, trading_pairs_7d_amount, pool_provider_24h_dex_type, pool_provider_24h_amount, pool_provider_7d_dex_type, pool_provider_7d_amount, isJSON);
  }
  async post(
    _account: AptosAccount,
    amount: U64,
