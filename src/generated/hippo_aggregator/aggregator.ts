...
export class EventStore 
{
  ...
  { name: "swap_step_events", typeTag: new StructTag(new HexString("0x1"), "event", "EventHandle", [new StructTag(new HexString("0xdad1c1d54fcff3bf0d83b4b0067d7cf0ebdca3ff17556f77115ada2db1ff23fe"), "aggregator", "SwapStepEvent", [])]) }];
...
export function emit_swap_step_event_ (
  ...
  let event_store;
  event_store = $c.borrow_global_mut<EventStore>(new SimpleStructTag(EventStore), new HexString("0xdad1c1d54fcff3bf0d83b4b0067d7cf0ebdca3ff17556f77115ada2db1ff23fe"));
...
export function get_intermediate_output_ (
  ...
  let temp$10, temp$13, temp$14, temp$15, temp$16, temp$17, temp$18, temp$19, temp$20, temp$22, temp$23, temp$24, temp$25, temp$26, temp$27, temp$28, temp$29, temp$3, temp$30, temp$31, temp$33, temp$4, temp$9, coin_in_value, coin_in_value__34, market_id, x_out, x_out__2, x_out_opt, x_value, y_out, y_out__1, y_out__11, y_out__12, y_out__21, y_out__32, y_out__5, y_out__7, zero, zero__6, zero2, zero2__8;
  ...
  if (($.copy(dex_type)).eq(($.copy(DEX_HIPPO)))) {
    ...
    if (($.copy(dex_type)).eq(($.copy(DEX_ECONIA)))) {
      ...
      if (is_x_to_y) {
        Econia.Market.swap_coins_(new HexString("0xdad1c1d54fcff3bf0d83b4b0067d7cf0ebdca3ff17556f77115ada2db1ff23fe"), $.copy(market_id), false, u64("0"), $.copy(x_value), u64("0"), $.copy(HI_64), u64("0"), x_in, y_out__21, $c, [$p[0], $p[1]]);
      }
      else{
        Econia.Market.swap_coins_(new HexString("0xdad1c1d54fcff3bf0d83b4b0067d7cf0ebdca3ff17556f77115ada2db1ff23fe"), $.copy(market_id), true, u64("0"), $.copy(HI_64), u64("0"), $.copy(x_value), $.copy(HI_64), y_out__21, x_in, $c, [$p[1], $p[0]]);
      }
      ...
      if (($.copy(dex_type)).eq(($.copy(DEX_PONTEM)))) {
        [temp$26, temp$27] = [Stdlib.Option.none_($c, [new StructTag(new HexString("0x1"), "coin", "Coin", [$p[0]])]), Pontem.Router.swap_exact_coin_for_coin_(new HexString("0xdad1c1d54fcff3bf0d83b4b0067d7cf0ebdca3ff17556f77115ada2db1ff23fe"), x_in, u64("0"), $c, [$p[0], $p[1], $p[2]])];
      }
      else{
        if (($.copy(dex_type)).eq(($.copy(DEX_BASIQ)))) {
          [temp$24, temp$25] = [Stdlib.Option.none_($c, [new StructTag(new HexString("0x1"), "coin", "Coin", [$p[0]])]), Basiq.Dex.swap_(x_in, $c, [$p[0], $p[1]])];
        }
        else{
...
export function loadParsers(repo: AptosParserRepo) {
  repo.addParser("0xdad1c1d54fcff3bf0d83b4b0067d7cf0ebdca3ff17556f77115ada2db1ff23fe::aggregator::EventStore", EventStore.EventStoreParser);
  repo.addParser("0xdad1c1d54fcff3bf0d83b4b0067d7cf0ebdca3ff17556f77115ada2db1ff23fe::aggregator::SwapStepEvent", SwapStepEvent.SwapStepEventParser);
}
export class App {
  constructor(
