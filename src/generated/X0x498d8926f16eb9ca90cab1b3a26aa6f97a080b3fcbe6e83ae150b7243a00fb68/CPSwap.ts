...
export const MODULE_ADMIN: HexString = new HexString("498d8926f16eb9ca90cab1b3a26aa6f97a080b3fcbe6e83ae150b7243a00fb68");
...
export class TokenPairMetadata {
  ...
  static fields: FieldDeclType[] = [
    ...
    {name: "lp", typeTag: parseTypeTagOrThrow("0x1::Coin::Coin<0x498d8926f16eb9ca90cab1b3a26aa6f97a080b3fcbe6e83ae150b7243a00fb68::CPSwap::LPToken<$tv0,$tv1>>")},
    {name: "balance_x", typeTag: parseTypeTagOrThrow("0x1::Coin::Coin<$tv0>")},
    {name: "balance_y", typeTag: parseTypeTagOrThrow("0x1::Coin::Coin<$tv1>")},
    {name: "mint_cap", typeTag: parseTypeTagOrThrow("0x1::Coin::MintCapability<0x498d8926f16eb9ca90cab1b3a26aa6f97a080b3fcbe6e83ae150b7243a00fb68::CPSwap::LPToken<$tv0,$tv1>>")},
    {name: "burn_cap", typeTag: parseTypeTagOrThrow("0x1::Coin::BurnCapability<0x498d8926f16eb9ca90cab1b3a26aa6f97a080b3fcbe6e83ae150b7243a00fb68::CPSwap::LPToken<$tv0,$tv1>>")}
  ];
...
export function loadParsers(repo: AptosParserRepo) {
  repo.addParser("0x498d8926f16eb9ca90cab1b3a26aa6f97a080b3fcbe6e83ae150b7243a00fb68::CPSwap::LPToken", LPToken.LPTokenParser);
  repo.addParser("0x498d8926f16eb9ca90cab1b3a26aa6f97a080b3fcbe6e83ae150b7243a00fb68::CPSwap::TokenPairMetadata", TokenPairMetadata.TokenPairMetadataParser);
  repo.addParser("0x498d8926f16eb9ca90cab1b3a26aa6f97a080b3fcbe6e83ae150b7243a00fb68::CPSwap::TokenPairReserve", TokenPairReserve.TokenPairReserveParser);
}