...
export class TokenInfo 
{
  ...
  delisted: boolean;
  token_type: aptos_framework$_.type_info$_.TypeInfo;
  ...
  constructor(proto: any, public typeTag: TypeTag) {
    ...
    this.token_type = proto['token_type'] as aptos_framework$_.type_info$_.TypeInfo;
  }
...
export class TokenRegistry 
{
  ...
  admin: HexString;
  symbol_to_token_info: aptos_framework$_.table$_.Table;
  type_info_to_symbol: aptos_framework$_.table$_.Table;
  symbol_to_list_idx: aptos_framework$_.table$_.Table;
  token_info_list: TokenInfo[];

  constructor(proto: any, public typeTag: TypeTag) {
    this.admin = proto['admin'] as HexString;
    this.symbol_to_token_info = proto['symbol_to_token_info'] as aptos_framework$_.table$_.Table;
    this.type_info_to_symbol = proto['type_info_to_symbol'] as aptos_framework$_.table$_.Table;
    this.symbol_to_list_idx = proto['symbol_to_list_idx'] as aptos_framework$_.table$_.Table;
...
export function add_token$ (
  ...
  type_info = aptos_framework$_.type_info$_.type_of$($c, [$p[0]] as TypeTag[]);
  ...
  if (!!aptos_framework$_.table$_.contains$(registry.symbol_to_token_info, $.copy(token_info.symbol), $c, [new StructTag(new HexString("0x1"), "string", "String", []), new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "token_registry", "TokenInfo", [])] as TypeTag[])) {
    throw $.abortCode(E_SYMBOL_ALREADY_EXISTS);
  }
  if (!!aptos_framework$_.table$_.contains$(registry.type_info_to_symbol, $.copy(type_info), $c, [new StructTag(new HexString("0x1"), "type_info", "TypeInfo", []), new StructTag(new HexString("0x1"), "string", "String", [])] as TypeTag[])) {
    throw $.abortCode(E_TYPE_ALREADY_EXISTS);
  }
  aptos_framework$_.table$_.add$(registry.symbol_to_token_info, $.copy(token_info.symbol), $.copy(token_info), $c, [new StructTag(new HexString("0x1"), "string", "String", []), new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "token_registry", "TokenInfo", [])] as TypeTag[]);
  aptos_framework$_.table$_.add$(registry.type_info_to_symbol, $.copy(type_info), $.copy(token_info.symbol), $c, [new StructTag(new HexString("0x1"), "type_info", "TypeInfo", []), new StructTag(new HexString("0x1"), "string", "String", [])] as TypeTag[]);
  ...
  aptos_framework$_.table$_.add$(registry.symbol_to_list_idx, $.copy(token_info.symbol), $.copy(index), $c, [new StructTag(new HexString("0x1"), "string", "String", []), AtomicTypeTag.U64] as TypeTag[]);
  return;
}
...
export function delist_token$ (
  ...
  if (!aptos_framework$_.table$_.contains$(registry.symbol_to_token_info, $.copy(symbol_str), $c, [new StructTag(new HexString("0x1"), "string", "String", []), new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "token_registry", "TokenInfo", [])] as TypeTag[])) {
    throw $.abortCode(E_SYMBOL_DOES_NOT_EXIST);
  }
  index = $.copy(aptos_framework$_.table$_.borrow$(registry.symbol_to_list_idx, $.copy(symbol_str), $c, [new StructTag(new HexString("0x1"), "string", "String", []), AtomicTypeTag.U64] as TypeTag[]));
  type_info = $.copy(aptos_framework$_.table$_.borrow$(registry.symbol_to_token_info, $.copy(symbol_str), $c, [new StructTag(new HexString("0x1"), "string", "String", []), new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "token_registry", "TokenInfo", [])] as TypeTag[]).token_type);
  ...
  aptos_framework$_.table$_.remove$(registry.symbol_to_list_idx, $.copy(symbol_str), $c, [new StructTag(new HexString("0x1"), "string", "String", []), AtomicTypeTag.U64] as TypeTag[]);
  aptos_framework$_.table$_.remove$(registry.symbol_to_token_info, $.copy(symbol_str), $c, [new StructTag(new HexString("0x1"), "string", "String", []), new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "token_registry", "TokenInfo", [])] as TypeTag[]);
  aptos_framework$_.table$_.remove$(registry.type_info_to_symbol, $.copy(type_info), $c, [new StructTag(new HexString("0x1"), "type_info", "TypeInfo", []), new StructTag(new HexString("0x1"), "string", "String", [])] as TypeTag[]);
  return;
}
...
export function has_token$ (
  ...
  type_info = aptos_framework$_.type_info$_.type_of$($c, [$p[0]] as TypeTag[]);
  return aptos_framework$_.table$_.contains$(registry.type_info_to_symbol, $.copy(type_info), $c, [new StructTag(new HexString("0x1"), "type_info", "TypeInfo", []), new StructTag(new HexString("0x1"), "string", "String", [])] as TypeTag[]);
}
...
export function initialize$ (
  ...
  temp$2 = aptos_framework$_.table$_.new__$($c, [new StructTag(new HexString("0x1"), "string", "String", []), new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "token_registry", "TokenInfo", [])] as TypeTag[]);
  temp$3 = aptos_framework$_.table$_.new__$($c, [new StructTag(new HexString("0x1"), "type_info", "TypeInfo", []), new StructTag(new HexString("0x1"), "string", "String", [])] as TypeTag[]);
  ...
  temp$5 = aptos_framework$_.table$_.new__$($c, [new StructTag(new HexString("0x1"), "string", "String", []), AtomicTypeTag.U64] as TypeTag[]);
...
export function update_token_info$ (
  ...
  table_token_info = aptos_framework$_.table$_.borrow_mut$(registry.symbol_to_token_info, $.copy(symbol_str), $c, [new StructTag(new HexString("0x1"), "string", "String", []), new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "token_registry", "TokenInfo", [])] as TypeTag[]);
