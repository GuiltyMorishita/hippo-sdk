...
export class TokenRegistry {
  ...
  static fields: FieldDeclType[] = [
    ...
    {name: "symbol_to_token_info", typeTag: parseTypeTagOrThrow("0x1::Table::Table<0x1::ASCII::String,0xf70ac33c984f8b7bead655ad239d246f1c0e3ca55fe0b8bfc119aa529c4630e8::TokenRegistry4::TokenInfo>")},
    ...
    {name: "token_info_list", typeTag: parseTypeTagOrThrow("vector<0xf70ac33c984f8b7bead655ad239d246f1c0e3ca55fe0b8bfc119aa529c4630e8::TokenRegistry4::TokenInfo>")}
  ];
...
export async function initialize_script(
  ...
  return sendAndWait(
    client,
    account,
    "0xf70ac33c984f8b7bead655ad239d246f1c0e3ca55fe0b8bfc119aa529c4630e8::TokenRegistry4::initialize_script",
    typeParamStrings,
    []
  );
}
...
export async function add_token_script(
  ...
  return sendAndWait(
    client,
    account,
    "0xf70ac33c984f8b7bead655ad239d246f1c0e3ca55fe0b8bfc119aa529c4630e8::TokenRegistry4::add_token_script",
    typeParamStrings,
    [
      name.hex(),
      symbol.hex(),
...
export async function delist_token_script(
  ...
  return sendAndWait(
    client,
    account,
    "0xf70ac33c984f8b7bead655ad239d246f1c0e3ca55fe0b8bfc119aa529c4630e8::TokenRegistry4::delist_token_script",
    typeParamStrings,
    [
      symbol.hex(),
    ]
...
export async function update_token_info_script(
  ...
  return sendAndWait(
    client,
    account,
    "0xf70ac33c984f8b7bead655ad239d246f1c0e3ca55fe0b8bfc119aa529c4630e8::TokenRegistry4::update_token_info_script",
    typeParamStrings,
    [
      symbol.hex(),
      description.hex(),
...
export function loadParsers(repo: AptosParserRepo) {
  repo.addParser("0xf70ac33c984f8b7bead655ad239d246f1c0e3ca55fe0b8bfc119aa529c4630e8::TokenRegistry4::TokenInfo", TokenInfo.TokenInfoParser);
  repo.addParser("0xf70ac33c984f8b7bead655ad239d246f1c0e3ca55fe0b8bfc119aa529c4630e8::TokenRegistry4::TokenRegistry", TokenRegistry.TokenRegistryParser);
}