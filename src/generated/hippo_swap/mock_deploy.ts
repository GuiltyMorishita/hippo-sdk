...
export function init_coin_and_create_store$ (
  ...
  if (!coin_registry$_.coin_registry$_.has_token$(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), $c, [$p[0]] as TypeTag[])) {
    coin_registry$_.coin_registry$_.add_token$(admin, $.copy(name), $.copy(symbol), $.copy(name), u8($.copy(decimals)), [], [], $c, [$p[0]] as TypeTag[]);
  }
  else{
  }
  return;
...
export function init_registry$ (
  ...
  if (!coin_registry$_.coin_registry$_.is_registry_initialized$(std$_.signer$_.address_of$(admin, $c), $c)) {
