...
export function get_D_newton_method_ (
  ...
  [result, ] = recur_D_newton_method_($.copy(d0), $.copy(x), $.copy(y), u128($.copy(amp)), u128("0"), u128("100"), $c);
  return $.copy(result);
}
...
export function get_D_origin_ (
  ...
  if (($.copy(s)).eq((u128("0")))) {
    ...
    [result, _iter] = recur_D_origin_($.copy(d), $.copy(x), $.copy(y), $.copy(s), $.copy(ann), $.copy(iter), $.copy(end), $c);
    temp$1 = $.copy(result);
  }
  return temp$1;
}
...
export function get_y_ (
  ...
  [result, ] = recur_y_($.copy(y), $.copy(b), $.copy(c), $.copy(d), u128("0"), u128("100"), $c);
  return $.copy(result);
}
...
export function recur_D_improved_ (
  ...
  if (($.copy(result)).eq((u128("0")))) {
    [temp$3, temp$4] = recur_D_improved_($.copy(new_d), $.copy(x), $.copy(y), $.copy(s), $.copy(ann), ($.copy(iter)).add(u128("1")), $.copy(end), $c);
  }
  else{
...
export function recur_D_newton_method_ (
  ...
  if (($.copy(minuend)).le(u128("1"))) {
    ...
    [temp$1, temp$2] = recur_D_newton_method_($.copy(d1), $.copy(x), $.copy(y), $.copy(amp), ($.copy(iter)).add(u128("1")), $.copy(end), $c);
  }
...
export function recur_D_origin_ (
  ...
  if (($.copy(result)).eq((u128("0")))) {
    [temp$3, temp$4] = recur_D_origin_($.copy(new_d), $.copy(x), $.copy(y), $.copy(s), $.copy(ann), ($.copy(iter)).add(u128("1")), $.copy(end), $c);
  }
  else{
    [temp$3, temp$4] = [$.copy(result), $.copy(iter)];
  }
...
export function recur_y_ (
  ...
  if (($.copy(difference)).le(u128("1"))) {
    ...
    return recur_y_($.copy(y_next), $.copy(b), $.copy(c), $.copy(d), ($.copy(iter)).add(u128("1")), $.copy(end), $c);
  }
}
