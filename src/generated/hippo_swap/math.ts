...
export function max_u64_(a: U64, b: U64, $c: AptosDataCache): U64 {
  let temp$1;
  if ($.copy(a).lt($.copy(b))) {
    temp$1 = $.copy(b);
  } else {
...
export function pow_(base: U128, exp: U8, $c: AptosDataCache): U128 {
  let result;
  result = u128('1');
  while (true) {
...
export function sqrt_(y: U128, $c: AptosDataCache): U128 {
