...
export function mock_deploy_script_ (
  ...
  mock_create_pair_and_add_liquidity_(admin, [u8("66"), u8("84"), u8("67"), u8("45"), u8("85"), u8("83"), u8("68"), u8("67")], $.copy(btc_amt), ($.copy(btc_amt)).mul(u64("10000")), (($.copy(btc_amt)).mul(u64("100"))).sub(u64("1000")), $c, [new StructTag(new HexString("0xb5d6dbc225e8c42cec66664ebbccaef2098107f699510613a0b90214f659bb46"), "devnet_coins", "DevnetBTC", []), new StructTag(new HexString("0xb5d6dbc225e8c42cec66664ebbccaef2098107f699510613a0b90214f659bb46"), "devnet_coins", "DevnetUSDC", [])]);
  mock_create_pair_and_add_liquidity_(admin, [u8("66"), u8("84"), u8("67"), u8("45"), u8("85"), u8("83"), u8("68"), u8("84")], $.copy(btc_amt), ($.copy(btc_amt)).mul(u64("10000")), (($.copy(btc_amt)).mul(u64("100"))).sub(u64("1000")), $c, [new StructTag(new HexString("0xb5d6dbc225e8c42cec66664ebbccaef2098107f699510613a0b90214f659bb46"), "devnet_coins", "DevnetBTC", []), new StructTag(new HexString("0xb5d6dbc225e8c42cec66664ebbccaef2098107f699510613a0b90214f659bb46"), "devnet_coins", "DevnetUSDT", [])]);
  return;
}
