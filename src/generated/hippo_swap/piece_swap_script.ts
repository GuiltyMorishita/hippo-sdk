...
export function mock_deploy_script_ (
  ...
  create_new_pool_script_(admin, [u8("85"), u8("83"), u8("68"), u8("84"), u8("45"), u8("85"), u8("83"), u8("68"), u8("67"), u8("32"), u8("80"), u8("105"), u8("101"), u8("99"), u8("101"), u8("83"), u8("119"), u8("97"), u8("112"), u8("32"), u8("76"), u8("80"), u8("32"), u8("84"), u8("111"), u8("107"), u8("101"), u8("110")], [u8("85"), u8("83"), u8("68"), u8("84"), u8("45"), u8("85"), u8("83"), u8("68"), u8("67")], ($.copy(billion)).mul($.copy(billion)), u128("110"), u128("100"), u128("105"), u128("100"), u64("100"), u64("100"), $c, [new StructTag(new HexString("0xb5d6dbc225e8c42cec66664ebbccaef2098107f699510613a0b90214f659bb46"), "devnet_coins", "DevnetUSDT", []), new StructTag(new HexString("0xb5d6dbc225e8c42cec66664ebbccaef2098107f699510613a0b90214f659bb46"), "devnet_coins", "DevnetUSDC", [])]);
  create_new_pool_script_(admin, [u8("68"), u8("65"), u8("73"), u8("45"), u8("85"), u8("83"), u8("68"), u8("67"), u8("32"), u8("80"), u8("105"), u8("101"), u8("99"), u8("101"), u8("83"), u8("119"), u8("97"), u8("112"), u8("32"), u8("76"), u8("80"), u8("32"), u8("84"), u8("111"), u8("107"), u8("101"), u8("110")], [u8("68"), u8("65"), u8("73"), u8("45"), u8("85"), u8("83"), u8("68"), u8("67")], ($.copy(billion)).mul($.copy(billion)), u128("110"), u128("100"), u128("105"), u128("100"), u64("100"), u64("100"), $c, [new StructTag(new HexString("0xb5d6dbc225e8c42cec66664ebbccaef2098107f699510613a0b90214f659bb46"), "devnet_coins", "DevnetDAI", []), new StructTag(new HexString("0xb5d6dbc225e8c42cec66664ebbccaef2098107f699510613a0b90214f659bb46"), "devnet_coins", "DevnetUSDC", [])]);
  initial_amount = (u64("1000000")).mul(u64("100000000"));
  Coin_list.Devnet_coins.mint_to_wallet_(admin, $.copy(initial_amount), $c, [new StructTag(new HexString("0xb5d6dbc225e8c42cec66664ebbccaef2098107f699510613a0b90214f659bb46"), "devnet_coins", "DevnetUSDT", [])]);
  Coin_list.Devnet_coins.mint_to_wallet_(admin, $.copy(initial_amount), $c, [new StructTag(new HexString("0xb5d6dbc225e8c42cec66664ebbccaef2098107f699510613a0b90214f659bb46"), "devnet_coins", "DevnetUSDC", [])]);
  add_liquidity_script_(admin, $.copy(initial_amount), $.copy(initial_amount), $c, [new StructTag(new HexString("0xb5d6dbc225e8c42cec66664ebbccaef2098107f699510613a0b90214f659bb46"), "devnet_coins", "DevnetUSDT", []), new StructTag(new HexString("0xb5d6dbc225e8c42cec66664ebbccaef2098107f699510613a0b90214f659bb46"), "devnet_coins", "DevnetUSDC", [])]);
  Coin_list.Devnet_coins.mint_to_wallet_(admin, $.copy(initial_amount), $c, [new StructTag(new HexString("0xb5d6dbc225e8c42cec66664ebbccaef2098107f699510613a0b90214f659bb46"), "devnet_coins", "DevnetDAI", [])]);
  Coin_list.Devnet_coins.mint_to_wallet_(admin, $.copy(initial_amount), $c, [new StructTag(new HexString("0xb5d6dbc225e8c42cec66664ebbccaef2098107f699510613a0b90214f659bb46"), "devnet_coins", "DevnetUSDC", [])]);
  add_liquidity_script_(admin, $.copy(initial_amount), $.copy(initial_amount), $c, [new StructTag(new HexString("0xb5d6dbc225e8c42cec66664ebbccaef2098107f699510613a0b90214f659bb46"), "devnet_coins", "DevnetDAI", []), new StructTag(new HexString("0xb5d6dbc225e8c42cec66664ebbccaef2098107f699510613a0b90214f659bb46"), "devnet_coins", "DevnetUSDC", [])]);
  return;
}
...
export class App {
  ...
  payload_create_new_pool_script(
    ...
    isJSON = false,
        ...
        | Types.TransactionPayload_EntryFunctionPayload {
    return buildPayload_create_new_pool_script(lp_name, lp_symbol, k, w1_numerator, w1_denominator, w2_numerator, w2_denominator, swap_fee_per_million, protocol_fee_share_per_thousand, $p, isJSON);
  }
  async create_new_pool_script(
    ...
    const payload = buildPayload_create_new_pool_script(lp_name, lp_symbol, k, w1_numerator, w1_denominator, w2_numerator, w2_denominator, swap_fee_per_million, protocol_fee_share_per_thousand, $p, _isJSON);
    return $.sendPayloadTx(this.client, _account, payload, _maxGas);
  }
