...
export function quote_(amount_x: U64, reserve_x: U64, reserve_y: U64, $c: AptosDataCache): U64 {
  let temp$1;
  ...
  return u64(
    Safe_math.div_(Safe_math.mul_(u128($.copy(amount_x)), u128($.copy(reserve_y)), $c), u128($.copy(reserve_x)), $c)
  );
}
