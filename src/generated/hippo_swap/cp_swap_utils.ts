...
export function get_amount_out$ (
  ...
  amount_in_with_fee = safe_math$_.mul$(u128($.copy(amount_in)), u128("997"), $c);
  numerator = safe_math$_.mul$($.copy(amount_in_with_fee), u128($.copy(reserve_out)), $c);
  denominator = safe_math$_.mul$(u128($.copy(reserve_in)), u128("1000"), $c).add($.copy(amount_in_with_fee));
  return u64(safe_math$_.div$($.copy(numerator), $.copy(denominator), $c));
}
...
export function quote$ (
  ...
  return u64(safe_math$_.div$(safe_math$_.mul$(u128($.copy(amount_x)), u128($.copy(reserve_y)), $c), u128($.copy(reserve_x)), $c));
}
