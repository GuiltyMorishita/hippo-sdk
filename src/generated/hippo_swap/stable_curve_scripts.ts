...
export function create_new_pool_ (
  ...
  Stable_curve_swap.initialize_(admin, Stdlib.String.utf8_($.copy(lp_name), $c), Stdlib.String.utf8_($.copy(lp_symbol), $c), $.copy(decimals__1), u64("60"), u64("80"), $.copy(block_timestamp), $.copy(future_time), $.copy(fee), $.copy(admin_fee), $c, [$p[0], $p[1]]);
  return;
}
...
export function mock_create_pair_and_add_liquidity_ (
  ...
  if (!(Stdlib.Coin.value_(some_lp, $c, [new StructTag(new HexString("0xa61e1e86e9f596e483283727d2739ba24b919012720648c29380f9cd0a96c11a"), "stable_curve_swap", "LPToken", [$p[0], $p[1]])])).eq(($.copy(lp_amt)))) {
...
export function mock_deploy_script_ (
  ...
  mock_create_pair_and_add_liquidity_(admin, [u8("85"), u8("83"), u8("68"), u8("67"), u8("45"), u8("85"), u8("83"), u8("68"), u8("84")], $.copy(fee), $.copy(admin_fee), ($.copy(coin_amt)).mul(u64("100")), ($.copy(coin_amt)).mul(u64("100")), u64("200000000000"), $c, [new StructTag(new HexString("0xb5d6dbc225e8c42cec66664ebbccaef2098107f699510613a0b90214f659bb46"), "devnet_coins", "DevnetUSDC", []), new StructTag(new HexString("0xb5d6dbc225e8c42cec66664ebbccaef2098107f699510613a0b90214f659bb46"), "devnet_coins", "DevnetUSDT", [])]);
  mock_create_pair_and_add_liquidity_(admin, [u8("85"), u8("83"), u8("68"), u8("67"), u8("45"), u8("68"), u8("65"), u8("73")], $.copy(fee), $.copy(admin_fee), ($.copy(coin_amt)).mul(u64("100")), ($.copy(coin_amt)).mul(u64("100")), u64("200000000000"), $c, [new StructTag(new HexString("0xb5d6dbc225e8c42cec66664ebbccaef2098107f699510613a0b90214f659bb46"), "devnet_coins", "DevnetUSDC", []), new StructTag(new HexString("0xb5d6dbc225e8c42cec66664ebbccaef2098107f699510613a0b90214f659bb46"), "devnet_coins", "DevnetSOL", [])]);
  return;
}
