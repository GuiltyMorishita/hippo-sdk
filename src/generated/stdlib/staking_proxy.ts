...
export function set_stake_pool_operator_(owner: HexString, new_operator: HexString, $c: AptosDataCache): void {
  let owner_address;
...
export function set_stake_pool_voter_(owner: HexString, new_voter: HexString, $c: AptosDataCache): void {
...
export function set_voter_(owner: HexString, operator: HexString, new_voter: HexString, $c: AptosDataCache): void {
...
export class App {
  ...
  async set_stake_pool_operator(_account: AptosAccount, new_operator: HexString, _maxGas = 1000, _isJSON = false) {
  ...
  async set_stake_pool_voter(_account: AptosAccount, new_voter: HexString, _maxGas = 1000, _isJSON = false) {
  ...
  async set_voter(_account: AptosAccount, operator: HexString, new_voter: HexString, _maxGas = 1000, _isJSON = false) {
