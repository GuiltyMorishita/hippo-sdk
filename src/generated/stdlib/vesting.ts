  ...
  static fields: FieldDeclType[] = [
    ...
    { name: 'nonce', typeTag: AtomicTypeTag.U64 },
    {
      ...
      typeTag: new StructTag(new HexString('0x1'), 'event', 'EventHandle', [
        new StructTag(new HexString('0x1'), 'vesting', 'CreateVestingContractEvent', [])
      ])
    }
  ];
...
export class VestingContract {
  ...
  static fields: FieldDeclType[] = [
    ...
    { name: 'signer_cap', typeTag: new StructTag(new HexString('0x1'), 'account', 'SignerCapability', []) },
    {
      ...
      typeTag: new StructTag(new HexString('0x1'), 'event', 'EventHandle', [
        new StructTag(new HexString('0x1'), 'vesting', 'UpdateOperatorEvent', [])
      ])
    },
    {
    ...
    },
    {
      ...
      typeTag: new StructTag(new HexString('0x1'), 'event', 'EventHandle', [
        new StructTag(new HexString('0x1'), 'vesting', 'SetBeneficiaryEvent', [])
      ])
    },
    {
      name: 'unlock_rewards_events',
      typeTag: new StructTag(new HexString('0x1'), 'event', 'EventHandle', [
        new StructTag(new HexString('0x1'), 'vesting', 'UnlockRewardsEvent', [])
      ])
    },
    {
      name: 'vest_events',
    ...
    },
    {
      ...
      typeTag: new StructTag(new HexString('0x1'), 'event', 'EventHandle', [
        new StructTag(new HexString('0x1'), 'vesting', 'AdminWithdrawEvent', [])
      ])
    }
  ];
...
export class VestingSchedule {
  ...
  static fields: FieldDeclType[] = [
    {
      name: 'schedule',
      typeTag: new VectorTag(new StructTag(new HexString('0x1'), 'fixed_point32', 'FixedPoint32', []))
    },
...
export function admin_withdraw_(admin: HexString, contract_address: HexString, $c: AptosDataCache): void {
...
export function assert_active_vesting_contract_(contract_address: HexString, $c: AptosDataCache): void {
...
export function assert_vesting_contract_exists_(contract_address: HexString, $c: AptosDataCache): void {
...
export function beneficiary_(
  ...
  return get_beneficiary_(
    $c.borrow_global<VestingContract>(new SimpleStructTag(VestingContract), $.copy(vesting_contract_address)),
    $.copy(shareholder),
    $c
  );
}

export function compute_vested_amount_(vesting_contract: VestingContract, $c: AptosDataCache): U64 {
  let temp$1,
  ...
  if (
    $.copy(schedule_index).lt(
      Vector.length_(schedule, $c, [new StructTag(new HexString('0x1'), 'fixed_point32', 'FixedPoint32', [])])
    )
  ) {
    temp$1 = $.copy(
    ...
    temp$1 = $.copy(
      Vector.borrow_(
        schedule,
        Vector.length_(schedule, $c, [new StructTag(new HexString('0x1'), 'fixed_point32', 'FixedPoint32', [])]).sub(
          u64('1')
        ),
        $c,
        [new StructTag(new HexString('0x1'), 'fixed_point32', 'FixedPoint32', [])]
  ...
  while ($.copy(i).lt($.copy(len))) {
    {
      ...
      Pool_u64.buy_in_(
        grant_pool,
        $.copy(Vector.borrow_(shareholders, $.copy(i), $c, [AtomicTypeTag.Address])),
        $.copy(buy_in_amount),
        $c
      );
      ...
      new AdminStore(
        {
          ...
          nonce: u64('0'),
          create_events: Account.new_event_handle_(admin, $c, [new SimpleStructTag(CreateVestingContractEvent)])
        },
        new SimpleStructTag(AdminStore)
      )
    );
    ...
    new VestingContract(
      {
        ...
        beneficiaries: Simple_map.create_($c, [AtomicTypeTag.Address, AtomicTypeTag.Address]),
        ...
        update_voter_events: Account.new_event_handle_(contract_signer, $c, [new SimpleStructTag(UpdateVoterEvent)]),
        reset_lockup_events: Account.new_event_handle_(contract_signer, $c, [new SimpleStructTag(ResetLockupEvent)]),
        ...
        vest_events: Account.new_event_handle_(contract_signer, $c, [new SimpleStructTag(VestEvent)]),
        distribute_events: Account.new_event_handle_(contract_signer, $c, [new SimpleStructTag(DistributeEvent)]),
        terminate_events: Account.new_event_handle_(contract_signer, $c, [new SimpleStructTag(TerminateEvent)]),
        admin_withdraw_events: Account.new_event_handle_(contract_signer, $c, [new SimpleStructTag(AdminWithdrawEvent)])
      },
      new SimpleStructTag(VestingContract)
    )
  );
...
export function create_vesting_schedule_(
  ...
  if (
    !Vector.length_(schedule, $c, [new StructTag(new HexString('0x1'), 'fixed_point32', 'FixedPoint32', [])]).gt(
      u64('0')
    )
  ) {
...
export function distribute_(contract_address: HexString, $c: AptosDataCache): void {
  let temp$1,
    temp$2,
    temp$3,
    temp$4,
...
export function buildPayload_distribute(
  ...
  const typeParamStrings = [] as string[];
  return $.buildPayload(new HexString('0x1'), 'vesting', 'distribute', typeParamStrings, [contract_address], isJSON);
}
export function get_beneficiary_(contract: VestingContract, shareholder: HexString, $c: AptosDataCache): HexString {
  let temp$1;
  if (
    Simple_map.contains_key_(contract.beneficiaries, shareholder, $c, [AtomicTypeTag.Address, AtomicTypeTag.Address])
  ) {
    temp$1 = $.copy(
      Simple_map.borrow_(contract.beneficiaries, shareholder, $c, [AtomicTypeTag.Address, AtomicTypeTag.Address])
    );
  } else {
...
export function get_role_holder_(contract_address: HexString, role: String.String, $c: AptosDataCache): HexString {
  let roles;
...
export function get_vesting_account_signer_internal_(vesting_contract: VestingContract, $c: AptosDataCache): HexString {
  return Account.create_signer_with_capability_(vesting_contract.signer_cap, $c);
}

export function operator_(vesting_contract_address: HexString, $c: AptosDataCache): HexString {
  assert_vesting_contract_exists_($.copy(vesting_contract_address), $c);
  return $.copy(
    $c.borrow_global<VestingContract>(new SimpleStructTag(VestingContract), $.copy(vesting_contract_address)).staking
      .operator
  );
}

export function operator_commission_percentage_(vesting_contract_address: HexString, $c: AptosDataCache): U64 {
  assert_vesting_contract_exists_($.copy(vesting_contract_address), $c);
  return $.copy(
    $c.borrow_global<VestingContract>(new SimpleStructTag(VestingContract), $.copy(vesting_contract_address)).staking
...
export function remaining_grant_(vesting_contract_address: HexString, $c: AptosDataCache): U64 {
  assert_vesting_contract_exists_($.copy(vesting_contract_address), $c);
  return $.copy(
    $c.borrow_global<VestingContract>(new SimpleStructTag(VestingContract), $.copy(vesting_contract_address))
      .remaining_grant
...
export function reset_beneficiary_(
  ...
  if ($.copy(addr).hex() === $.copy(vesting_contract.admin).hex()) {
    ...
    temp$1 =
      $.copy(addr).hex() ===
      get_role_holder_($.copy(contract_address), String.utf8_($.copy(ROLE_BENEFICIARY_RESETTER), $c), $c).hex();
  }
  if (!temp$1) {
...
export function reset_lockup_(admin: HexString, contract_address: HexString, $c: AptosDataCache): void {
    ...
    new ResetLockupEvent(
      {
        ...
        new_lockup_expiration_secs: Stake.get_lockup_secs_($.copy(vesting_contract.staking.pool_address), $c)
      },
...
export function buildPayload_reset_lockup(
  ...
  const typeParamStrings = [] as string[];
  return $.buildPayload(new HexString('0x1'), 'vesting', 'reset_lockup', typeParamStrings, [contract_address], isJSON);
}
export function set_beneficiary_(
  ...
  if (Simple_map.contains_key_(temp$5, temp$6, $c, [AtomicTypeTag.Address, AtomicTypeTag.Address])) {
    ...
    Simple_map.add_(beneficiaries, $.copy(shareholder), $.copy(new_beneficiary), $c, [
      AtomicTypeTag.Address,
      AtomicTypeTag.Address
    ]);
  }
...
export function stake_pool_address_(vesting_contract_address: HexString, $c: AptosDataCache): HexString {
  assert_vesting_contract_exists_($.copy(vesting_contract_address), $c);
  return $.copy(
    $c.borrow_global<VestingContract>(new SimpleStructTag(VestingContract), $.copy(vesting_contract_address)).staking
      .pool_address
...
export function terminate_vesting_contract_(admin: HexString, contract_address: HexString, $c: AptosDataCache): void {
  ...
  Event.emit_event_(
    ...
    new TerminateEvent(
      { admin: $.copy(vesting_contract.admin), vesting_contract_address: $.copy(contract_address) },
...
export function unlock_rewards_(contract_address: HexString, $c: AptosDataCache): void {
...
export function unlock_stake_(vesting_contract: VestingContract, amount: U64, $c: AptosDataCache): void {
...
export function verify_admin_(admin: HexString, vesting_contract: VestingContract, $c: AptosDataCache): void {
      ...
      new VestEvent(
        {
          ...
          vesting_contract_address: $.copy(contract_address),
          staking_pool_address: $.copy(vesting_contract.staking.pool_address),
          period_vested: $.copy(period_vested),
...
export function buildPayload_vest(
  ...
  const typeParamStrings = [] as string[];
  return $.buildPayload(new HexString('0x1'), 'vesting', 'vest', typeParamStrings, [contract_address], isJSON);
}
export function vesting_contracts_(admin: HexString, $c: AptosDataCache): HexString[] {
  let temp$1;
...
export function vesting_start_secs_(vesting_contract_address: HexString, $c: AptosDataCache): U64 {
  assert_vesting_contract_exists_($.copy(vesting_contract_address), $c);
  return $.copy(
    $c.borrow_global<VestingContract>(new SimpleStructTag(VestingContract), $.copy(vesting_contract_address))
...
export function voter_(vesting_contract_address: HexString, $c: AptosDataCache): HexString {
  assert_vesting_contract_exists_($.copy(vesting_contract_address), $c);
  return $.copy(
    $c.borrow_global<VestingContract>(new SimpleStructTag(VestingContract), $.copy(vesting_contract_address)).staking
      .voter
