...
export class Option {
  ...
  static typeParameters: TypeParamDeclType[] = [{ name: 'Element', isPhantom: false }];
  static fields: FieldDeclType[] = [{ name: 'vec', typeTag: new VectorTag(new $.TypeParamIdx(0)) }];
...
export function borrow_(t: Option, $c: AptosDataCache, $p: TypeTag[] /* <Element>*/): any {
  if (!is_some_(t, $c, [$p[0]])) {
...
export function borrow_mut_(t: Option, $c: AptosDataCache, $p: TypeTag[] /* <Element>*/): any {
  if (!is_some_(t, $c, [$p[0]])) {
    throw $.abortCode($.copy(EOPTION_NOT_SET));
  }
...
export function contains_(t: Option, e_ref: any, $c: AptosDataCache, $p: TypeTag[] /* <Element>*/): boolean {
  return Vector.contains_(t.vec, e_ref, $c, [$p[0]]);
}

export function destroy_none_(t: Option, $c: AptosDataCache, $p: TypeTag[] /* <Element>*/): void {
  if (!is_none_(t, $c, [$p[0]])) {
...
export function destroy_some_(t: Option, $c: AptosDataCache, $p: TypeTag[] /* <Element>*/): any {
  let elem;
  if (!is_some_(t, $c, [$p[0]])) {
    throw $.abortCode($.copy(EOPTION_NOT_SET));
  }
...
export function extract_(t: Option, $c: AptosDataCache, $p: TypeTag[] /* <Element>*/): any {
  if (!is_some_(t, $c, [$p[0]])) {
    throw $.abortCode($.copy(EOPTION_NOT_SET));
  }
...
export function fill_(t: Option, e: any, $c: AptosDataCache, $p: TypeTag[] /* <Element>*/): void {
  let vec_ref;
  vec_ref = t.vec;
  if (Vector.is_empty_(vec_ref, $c, [$p[0]])) {
...
export function get_with_default_(t: Option, default__: any, $c: AptosDataCache, $p: TypeTag[] /* <Element>*/): any {
  let temp$1, vec_ref;
  vec_ref = t.vec;
  if (Vector.is_empty_(vec_ref, $c, [$p[0]])) {
...
export function is_none_(t: Option, $c: AptosDataCache, $p: TypeTag[] /* <Element>*/): boolean {
  return Vector.is_empty_(t.vec, $c, [$p[0]]);
}

export function is_some_(t: Option, $c: AptosDataCache, $p: TypeTag[] /* <Element>*/): boolean {
  return !Vector.is_empty_(t.vec, $c, [$p[0]]);
}

export function none_($c: AptosDataCache, $p: TypeTag[] /* <Element>*/): Option {
  return new Option({ vec: Vector.empty_($c, [$p[0]]) }, new SimpleStructTag(Option, [$p[0]]));
}

export function some_(e: any, $c: AptosDataCache, $p: TypeTag[] /* <Element>*/): Option {
  return new Option({ vec: Vector.singleton_(e, $c, [$p[0]]) }, new SimpleStructTag(Option, [$p[0]]));
}

export function swap_(t: Option, e: any, $c: AptosDataCache, $p: TypeTag[] /* <Element>*/): any {
...
export function swap_or_fill_(t: Option, e: any, $c: AptosDataCache, $p: TypeTag[] /* <Element>*/): Option {
...
export function to_vec_(t: Option, $c: AptosDataCache, $p: TypeTag[] /* <Element>*/): any[] {
  let { vec: vec } = t;
  return vec;
}
