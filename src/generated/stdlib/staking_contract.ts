  ...
  static fields: FieldDeclType[] = [
    {
      ...
      typeTag: new StructTag(new HexString('0x1'), 'simple_map', 'SimpleMap', [
        ...
        new StructTag(new HexString('0x1'), 'staking_contract', 'StakingContract', [])
      ])
    },
    {
      name: 'create_staking_contract_events',
      typeTag: new StructTag(new HexString('0x1'), 'event', 'EventHandle', [
        new StructTag(new HexString('0x1'), 'staking_contract', 'CreateStakingContractEvent', [])
      ])
    },
    {
      name: 'update_voter_events',
      typeTag: new StructTag(new HexString('0x1'), 'event', 'EventHandle', [
        new StructTag(new HexString('0x1'), 'staking_contract', 'UpdateVoterEvent', [])
      ])
    },
    {
      name: 'reset_lockup_events',
      typeTag: new StructTag(new HexString('0x1'), 'event', 'EventHandle', [
        new StructTag(new HexString('0x1'), 'staking_contract', 'ResetLockupEvent', [])
      ])
    },
    {
      name: 'add_stake_events',
      typeTag: new StructTag(new HexString('0x1'), 'event', 'EventHandle', [
        new StructTag(new HexString('0x1'), 'staking_contract', 'AddStakeEvent', [])
      ])
    },
    {
      name: 'request_commission_events',
      typeTag: new StructTag(new HexString('0x1'), 'event', 'EventHandle', [
        new StructTag(new HexString('0x1'), 'staking_contract', 'RequestCommissionEvent', [])
      ])
    },
    {
      name: 'unlock_stake_events',
      typeTag: new StructTag(new HexString('0x1'), 'event', 'EventHandle', [
        new StructTag(new HexString('0x1'), 'staking_contract', 'UnlockStakeEvent', [])
      ])
    },
    {
      name: 'switch_operator_events',
      typeTag: new StructTag(new HexString('0x1'), 'event', 'EventHandle', [
        new StructTag(new HexString('0x1'), 'staking_contract', 'SwitchOperatorEvent', [])
      ])
    },
    {
      name: 'add_distribution_events',
      typeTag: new StructTag(new HexString('0x1'), 'event', 'EventHandle', [
        new StructTag(new HexString('0x1'), 'staking_contract', 'AddDistributionEvent', [])
      ])
    },
    {
      name: 'distribute_events',
      typeTag: new StructTag(new HexString('0x1'), 'event', 'EventHandle', [
        new StructTag(new HexString('0x1'), 'staking_contract', 'DistributeEvent', [])
      ])
    }
  ];
...
export function add_distribution_(
  ...
  Event.emit_event_(
    ...
    new AddDistributionEvent(
      { operator: $.copy(operator), pool_address: $.copy(pool_address), amount: $.copy(coins_amount) },
...
export function add_stake_(staker: HexString, operator: HexString, amount: U64, $c: AptosDataCache): void {
  ...
  staking_contract = Simple_map.borrow_mut_(store.staking_contracts, operator, $c, [
    AtomicTypeTag.Address,
  ...
  Event.emit_event_(
    ...
    new AddStakeEvent(
      { operator: $.copy(operator), pool_address: $.copy(pool_address), amount: $.copy(amount) },
...
export function assert_staking_contract_exists_(staker: HexString, operator: HexString, $c: AptosDataCache): void {
    ...
    new StakingContract(
      {
        ...
        distribution_pool: Pool_u64.create_($.copy(MAXIMUM_PENDING_DISTRIBUTIONS), $c),
...
export function distribute_(staker: HexString, operator: HexString, $c: AptosDataCache): void {
...
export function new_staking_contracts_holder_(staker: HexString, $c: AptosDataCache): Store {
  return new Store(
    {
      staking_contracts: Simple_map.create_($c, [AtomicTypeTag.Address, new SimpleStructTag(StakingContract)]),
      create_staking_contract_events: Account.new_event_handle_(staker, $c, [
        new SimpleStructTag(CreateStakingContractEvent)
      ]),
      update_voter_events: Account.new_event_handle_(staker, $c, [new SimpleStructTag(UpdateVoterEvent)]),
      reset_lockup_events: Account.new_event_handle_(staker, $c, [new SimpleStructTag(ResetLockupEvent)]),
      add_stake_events: Account.new_event_handle_(staker, $c, [new SimpleStructTag(AddStakeEvent)]),
      request_commission_events: Account.new_event_handle_(staker, $c, [new SimpleStructTag(RequestCommissionEvent)]),
      unlock_stake_events: Account.new_event_handle_(staker, $c, [new SimpleStructTag(UnlockStakeEvent)]),
      switch_operator_events: Account.new_event_handle_(staker, $c, [new SimpleStructTag(SwitchOperatorEvent)]),
      add_distribution_events: Account.new_event_handle_(staker, $c, [new SimpleStructTag(AddDistributionEvent)]),
      distribute_events: Account.new_event_handle_(staker, $c, [new SimpleStructTag(DistributeEvent)])
    },
...
export function request_commission_internal_(
  ...
  [total_active_stake, accumulated_rewards, commission_amount] = get_staking_contract_amounts_internal_(
    staking_contract,
    $c
  );
...
export function reset_lockup_(staker: HexString, operator: HexString, $c: AptosDataCache): void {
...
export function buildPayload_reset_lockup(
  ...
  const typeParamStrings = [] as string[];
  return $.buildPayload(new HexString('0x1'), 'staking_contract', 'reset_lockup', typeParamStrings, [operator], isJSON);
}
...
export function switch_operator_(
  ...
  [, staking_contract] = Simple_map.remove_(staking_contracts, old_operator, $c, [
    AtomicTypeTag.Address,
    new SimpleStructTag(StakingContract)
  ]);
  ...
  pool_address = $.copy(staking_contract.pool_address);
  Simple_map.add_(staking_contracts, $.copy(new_operator), staking_contract, $c, [
    AtomicTypeTag.Address,
    new SimpleStructTag(StakingContract)
  ]);
...
export function unlock_rewards_(staker: HexString, operator: HexString, $c: AptosDataCache): void {
...
export function unlock_stake_(staker: HexString, operator: HexString, amount: U64, $c: AptosDataCache): void {
  let temp$1,
    temp$2,
    temp$3,
    temp$4,
  ...
  Event.emit_event_(
    ...
    new UnlockStakeEvent(
      { operator: temp$2, pool_address: temp$1, amount: temp$3, commission_paid: temp$4 },
...
export function update_voter_(staker: HexString, operator: HexString, new_voter: HexString, $c: AptosDataCache): void {
