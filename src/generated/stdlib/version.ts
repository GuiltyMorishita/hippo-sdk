...
export class Version {
  ...
  static typeParameters: TypeParamDeclType[] = [];
  static fields: FieldDeclType[] = [{ name: 'major', typeTag: AtomicTypeTag.U64 }];
...
export function initialize_(aptos_framework: HexString, initial_version: U64, $c: AptosDataCache): void {
  System_addresses.assert_aptos_framework_(aptos_framework, $c);
  $c.move_to(
    new SimpleStructTag(Version),
    aptos_framework,
    new Version({ major: $.copy(initial_version) }, new SimpleStructTag(Version))
  );
  $c.move_to(
...
export function initialize_for_test_(core_resources: HexString, $c: AptosDataCache): void {
...
export function set_version_(account: HexString, major: U64, $c: AptosDataCache): void {
...
export function buildPayload_set_version(
  ...
  return $.buildPayload(new HexString('0x1'), 'version', 'set_version', typeParamStrings, [major], isJSON);
}
...
export class App {
  ...
  async set_version(_account: AptosAccount, major: U64, _maxGas = 1000, _isJSON = false) {
